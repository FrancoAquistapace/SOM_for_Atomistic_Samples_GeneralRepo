# Self Organising Map for Clustering of Atomistic Samples - V.2.1
## Description
...
## What's new in V.2.1:
Optimized both the classification process and the writing of the output file, so that the software can run faster. Also, the normalization process for the input data was updated.
