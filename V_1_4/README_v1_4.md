# Self Organising Map for Clustering of Atomistic Samples - V.1.4
## Description
...
- B: Batch size, in case the training uses batched learning.
...
## What's new in V.1.4:
- Updated training process of the network by implementing bacthed learning.
